...
- 🐛 **バグ報告**: [Issues](https://github.com/your-username/discord-translation-bot/issues)
- 💡 **機能リクエスト**: [Discussions](https://github.com/your-username/discord-translation-bot/discussions)
- 📧 **問い合わせ**: your-email@example.com

---

<div align="center">

**🌟 Discord Translation Botを使って、言語の壁を越えたコミュニケーションを始めましょう！ 🌟**
